...
function Step({ step, index }) {
  ...
  return (
    <div ref={ref} className="relative grid md:grid-cols-2 gap-6 items-center py-10 md:py-16 border-b border-stone-line last:border-b-0">
      <motion.span
        style={{ y }}
...
export default function HowItWorks() {
  return (
    <section className="px-6 md:px-16 pt-16 sm:pt-24 md:pt-32 pb-8 sm:pb-12 md:pb-16">
